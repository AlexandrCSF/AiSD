...
public class SimpleBinaryTree<T> implements BinaryTree<T> {
    ...
    public void solution(SimpleTreeNode curr) {
        SimpleTreeNode tmpLeft, tmpRight;
        if (curr.getLeft() != null && curr.getRight() == null) {
            tmpLeft = curr.getLeft().getLeft();
            tmpRight = curr.getLeft().getRight();
            curr.setValue(curr.getLeft().getValue());
            curr.left = tmpLeft;
            curr.right = tmpRight;
            solution(curr);
        } else if (curr.getLeft() == null && curr.getRight() != null) {
            tmpLeft = curr.getRight().getLeft();
            tmpRight = curr.getRight().getRight();
        ...
        if (curr.getLeft() != null) {
            solution(curr.getLeft());
        }
        if (curr.getRight() != null) {
            solution(curr.getRight());
        }
    }
